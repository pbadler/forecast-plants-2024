...
small_plant_growth_windows <- read_csv('output/growth_models/top_small_growth_windows.csv')
...
for( sp in species_list){ 
  ...
  # split training and testing for small plants ------------- # 
  temp_dat <- 
    size %>% 
  ...
  temp_name <- paste0( sp, '_small_plant_growth')
  ...
  model_name <- paste0( sp, '_small_plant_growth')
  saveRDS(my_mod, paste0( "output/growth_models/", model_name, ".rds"))
  ...
  model_name <- paste0( sp, '_small_plant_growth_null')
  saveRDS(my_mod_null, paste0( "output/growth_models/", model_name, ".rds"))
